            ...
            <div class="col-lg-8">
                <form method="post" action="/hikamin/anime/{{ $anime->slug }}/episode" class="mb-5">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('video_360p') is-invalid @enderror" id="video_360p" name="video_360p" required value="{{ old('video_360p') }}" />
                        @error('video_360p')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('video_480p') is-invalid @enderror" id="video_480p" name="video_480p" required value="{{ old('video_480p') }}" />
                        @error('video_480p')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('video_720p') is-invalid @enderror" id="video_720p" name="video_720p" required value="{{ old('video_720p') }}" />
                        @error('video_720p')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
